...
//        val kvizoviPrije = KvizRepository.getUpisani()
...
//        val nedodjeljeniKvizovi = KvizRepository.getAll().minus(KvizRepository.getUpisani())
...
//                )
//        ).perform(ViewActions.click())
//        val kvizoviPoslije = KvizRepository.getUpisani()
//
